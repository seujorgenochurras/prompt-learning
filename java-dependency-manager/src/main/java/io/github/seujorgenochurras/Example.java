...
public class Example {
    ...
    static File[] filesToMap = {new File(
        "java-dependency-manager/src/test/dependency-file-example/build.gradle.kts"), new File(
            "java-dependency-manager/src/test/dependency-file-example/build.gradle"), new File(
                "java-dependency-manager/src/test/dependency-file-example/pom.xml")};
